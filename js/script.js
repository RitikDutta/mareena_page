 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        ...
        function mt(t) {
            ...
            var x = X(c, O, i, s, y, l);
            r.dispatch((0, m.instanceAdded)((0, a.default)({ instanceId: g, elementId: w, origin: x, refType: A, skipMotion: S, skipToValue: n }, o))),
                        ...
                        /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0),
                            u &&
                                ...
                                ((e =
                                    ...
                                    (r = t("<img>").attr("src", "img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({ marginRight: "8px", width: "16px" })),
                                    (a = t("<img>").attr("src", "img/webflow-badge-text.6faa6a38cd.svg").attr("alt", "Made in Webflow")),
                                    n.append(r, a),
                                    n[0])),
                                d(),
                                setTimeout(d, 500),
            ...
            (t.exports = function (t, e) {
                ...
                function D(e, n) {
                    ...
                    if (e.index !== e.previous) {
                        ...
                        r.infinite && c.x
                            ? (f(e.slides.not(h)).set({ visibility: "", x: c.x }).add(w).start({ x: d }), f(h).set({ visibility: "", x: c.from }).add(w).start({ x: c.to }), (e.shifted = h))
                            : (r.infinite && e.shifted && (f(e.shifted).set({ visibility: "", x: l }), (e.shifted = null)), f(e.slides).set({ visibility: "" }).add(w).start({ x: d }));
                    }
                    function S() {
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: { id: "ad1c384f-735a-448d-e8be-076dc418fc52", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "ad1c384f-735a-448d-e8be-076dc418fc52", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1648972159450,
        },
        "e-2": {
            id: "e-2",
            name: "",
        ...
        "e-4": {
            ...
            target: { id: "6236be9ba96406d5d2e400f9", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "6236be9ba96406d5d2e400f9", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1649956967381,
        },
        "e-5": {
            id: "e-5",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "6236be9ba96406d5d2e400f9|8ffb550a-e009-04d3-1acc-15e35ddfe294", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "6236be9ba96406d5d2e400f9|8ffb550a-e009-04d3-1acc-15e35ddfe294", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1649957889912,
        },
        "e-6": {
            id: "e-6",
            name: "",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".top-line", selectorGuids: ["65b2152d-7845-4378-1b9b-d95f2af2f00f"] },
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "px",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".bottom-line", selectorGuids: ["af870b83-d148-212d-f754-4ee00f184cfb"] },
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "px",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".middle-line", selectorGuids: ["9692270f-3116-be72-03e4-0e864da1712c"] }, value: 0, unit: "" },
                        },
                    ],
                },
                {
                    ...
                    actionItems: [
                        {
                            id: "a-2-n-7",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".middle-line", selectorGuids: ["9692270f-3116-be72-03e4-0e864da1712c"] }, value: 1, unit: "" },
                        },
                    ],
                },
                {
                    ...
                    actionItems: [
                        {
                            id: "a-3-n",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 500, easing: "", duration: 200, target: { id: "6236be9ba96406d5d2e400f9|6715541e-cc76-78af-b6a2-63ddbe8389d5" }, yValue: 100, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-3-n-2",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 700, easing: "", duration: 200, target: { id: "6236be9ba96406d5d2e400f9|e0af2f33-87c7-fe83-c70a-cf4ca481bd31" }, yValue: 100, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: false,
            createdOn: 1649956971570,
        },
        "a-4": {
            id: "a-4",
            title: "Dish Hover in",
                    ...
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".dish-img", selectorGuids: ["345979f1-1280-2812-3592-9ac2b28f0419"] }, xValue: 1, yValue: 1, locked: true },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-4-n-2",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".dish-img", selectorGuids: ["345979f1-1280-2812-3592-9ac2b28f0419"] }, xValue: 1.03, yValue: 1.03, locked: true },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1649957896292,
        },
        "a-5": {
            id: "a-5",
            title: "Dish Hover out",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            id: "a-5-n",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, easing: "", duration: 300, target: { useEventTarget: "CHILDREN", selector: ".dish-img", selectorGuids: ["345979f1-1280-2812-3592-9ac2b28f0419"] }, xValue: 1, yValue: 1, locked: true },
                        },
                    ],
                },
            ],
                            ...
                            actionItems: [
                                {
                                    id: "a-6-n",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "6236be9ba96406d5d2e400f9|b6d7e607-5920-d7f2-7a4f-e13e7e190b17" }, zValue: 0, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-6-n-4",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "6236be9ba96406d5d2e400f9|b6d7e607-5920-d7f2-7a4f-e13e7e190b17" }, zValue: -2, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                            ],
                        },
                        {
